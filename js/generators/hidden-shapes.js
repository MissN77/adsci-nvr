...
function buildFigure(rng, shapes) {
  ...
  return `<svg viewBox="0 0 ${SIZE} ${SIZE}" width="${SIZE}" height="${SIZE}" class="fig fig--big" role="img" aria-label="a pattern of lines with a shape hidden inside it">${markup}</svg>`;
}
