...
export const ACTION_OBJECTS = [
  ...
  ['reap', 'corn'], ['carve', 'wood'], ['iron', 'shirt'], ['brew', 'tea'],
  ['hoist', 'sail'], ['stack', 'hay'], ['mend', 'fence'], ['bait', 'hook'],
  ['forge', 'iron'], ['thresh', 'wheat'],
];
